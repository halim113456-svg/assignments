...
Memory Usage	Might waste space	Uses only what we need
Overflow	Can happen if full	Rare, only if memory is full
How easy to make	Easy	Slightly harder (needs pointers)
